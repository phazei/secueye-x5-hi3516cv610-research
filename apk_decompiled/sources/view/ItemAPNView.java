...
public class ItemAPNView extends FrameLayout {
    ...
    public ItemAPNView(@NonNull Context context) {
        super(context);
        init(context);
    }

    public ItemAPNView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ItemAPNView);
        ...
        init(context, string, string2, string3, resourceId, resourceId2, resourceId3, z, z2, z3);
    }

    public ItemAPNView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_item_view_apn, (ViewGroup) this, true);
        this.tvTitle = (TextView) findViewById(R.id.tv_text_title_apn);
        this.tvDesc = (TextView) findViewById(R.id.tv_text_desc_apn);
        this.ivEnter = (ImageView) findViewById(R.id.iv_enter_apn);
        this.checkImage = (ImageView) findViewById(R.id.apn_check);
        this.flRgihtView = (FrameLayout) findViewById(R.id.fl_content_right_apn);
        this.line = findViewById(R.id.line);
    }

    private void init(Context context, String str, String str2, String str3, int i, int i2, int i3, boolean z, boolean z2, boolean z3) {
        LayoutInflater.from(context).inflate(R.layout.layout_item_view_apn, (ViewGroup) this, true);
        this.tvTitle = (TextView) findViewById(R.id.tv_text_title_apn);
        this.tvDesc = (TextView) findViewById(R.id.tv_text_desc_apn);
        this.tvRight = (TextView) findViewById(R.id.tv_text_right_apn);
        this.ivEnter = (ImageView) findViewById(R.id.iv_enter_apn);
        this.checkImage = (ImageView) findViewById(R.id.apn_check);
        this.flRgihtView = (FrameLayout) findViewById(R.id.fl_content_right_apn);
        this.line = findViewById(R.id.line_apn);
        setTitleText(str);
        setDescText(str2);
        setRightText(str3);
        setDescTextColor(i);
