...
public class EditView extends FrameLayout {
    ...
    public interface OnClickListener {
        ...
        void onDownloadClick(View view2);
    }
    ...
    public void addOnClickListener(final OnClickListener onClickListener) {
        this.tvCheckAll.setOnClickListener(new OnMultiClickListener() { // from class: view.EditView.1
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                onClickListener.OnCheckAllClick(view2);
            }
        });
        this.tvInverse.setOnClickListener(new OnMultiClickListener() { // from class: view.EditView.2
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                onClickListener.OnInverseClick(view2);
            }
        });
        this.tvDelete.setOnClickListener(new OnMultiClickListener() { // from class: view.EditView.3
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                onClickListener.OnDeleteClick(view2);
            }
        });
        this.tvDownload.setOnClickListener(new OnMultiClickListener() { // from class: view.EditView.4
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                onClickListener.onDownloadClick(view2);
            }
        });
    }
