...
public class IPCTitleView extends RelativeLayout {
    ...
    public interface OnImageClick {
        void OnRightImageClick(View view2);
    }
    ...
    public IPCTitleView(Context context, AttributeSet attributeSet) {
    ...
    public void setOnRightImageClick(final OnImageClick onImageClick) {
        this.rightImg.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onImageClick.OnRightImageClick(view2);
            }
        });
    }

    public void setOnViewClick(final OnViewClick onViewClick) {
        this.leftRl.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onViewClick.OnLeftClick(view2);
            }
        });
        this.rightLl.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onViewClick.OnRightClick(view2);
            }
        });
        this.rightText.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onViewClick.OnRightClick(view2);
            }
        });
        this.rightImg.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onViewClick.OnRightClick(view2);
            }
        });
        this.rightImg2.setOnClickListener(new View.OnClickListener() { // from class: view.IPCTitleView.6
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                onViewClick.OnRightClick(view2);
            }
