...
public class D implements SIGMeshBizRequestGenerator.a<Object> {
    ...
    public byte[] a(Object obj) {
        if (obj instanceof String) {
            try {
                short sRound = (short) Math.round(((double) Integer.parseInt((String) obj)) * 655.35d);
                return new byte[]{(byte) (sRound & Http2CodecUtil.MAX_UNSIGNED_BYTE), (byte) ((sRound >> 8) & 255)};
        ...
        short sRound2 = (short) Math.round(((double) ((Integer) obj).intValue()) * 655.35d);
        return new byte[]{(byte) (sRound2 & Http2CodecUtil.MAX_UNSIGNED_BYTE), (byte) ((sRound2 >> 8) & 255)};
    }
}
