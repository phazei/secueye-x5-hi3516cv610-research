...
public class RegisterSelectorDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view2, @Nullable Bundle bundle) {
        ...
        ((TextView) view2.findViewById(R.id.tv_title)).setText(ResourceUtils.getString(getActivity(), "account_choose_register_style"));
        ...
        textView2.setText(ResourceUtils.getString(getActivity(), "account_phone_register"));
        textView2.setOnClickListener(this.onClickListener);
        TextView textView3 = (TextView) view2.findViewById(R.id.btn_register_email);
        textView3.setText(ResourceUtils.getString(getActivity(), "ali_sdk_openaccount_text_email_register"));
