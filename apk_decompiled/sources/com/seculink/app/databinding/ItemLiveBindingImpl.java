...
public class ItemLiveBindingImpl extends ItemLiveBinding {
    ...
    public ItemLiveBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view2) {
        this(dataBindingComponent, view2, mapBindings(dataBindingComponent, view2, 1, sIncludes, sViewsWithIds));
    }

    private ItemLiveBindingImpl(DataBindingComponent dataBindingComponent, View view2, Object[] objArr) {
