...
public class ActivityConnectionFailedBindingImpl extends ActivityConnectionFailedBinding {
    ...
    public ActivityConnectionFailedBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view2) {
        this(dataBindingComponent, view2, mapBindings(dataBindingComponent, view2, 6, sIncludes, sViewsWithIds));
    }

    private ActivityConnectionFailedBindingImpl(DataBindingComponent dataBindingComponent, View view2, Object[] objArr) {
