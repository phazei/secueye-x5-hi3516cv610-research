...
public class ActivityNet4gSwitchBindingImpl extends ActivityNet4gSwitchBinding {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.layout_customer, 18);
        sViewsWithIds.put(R.id.layout_wechat, 19);
    }

    public ActivityNet4gSwitchBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view2) {
        this(dataBindingComponent, view2, mapBindings(dataBindingComponent, view2, 20, sIncludes, sViewsWithIds));
    }

    private ActivityNet4gSwitchBindingImpl(DataBindingComponent dataBindingComponent, View view2, Object[] objArr) {
        super(dataBindingComponent, view2, 0, (TitleView) objArr[1], (LongItemView) objArr[2], (ImageView) objArr[13], (ImageView) objArr[6], (LinearLayout) objArr[17], (LinearLayout) objArr[18], (LinearLayout) objArr[12], (LinearLayout) objArr[0], (LinearLayout) objArr[5], (LinearLayout) objArr[19], (LinearLayout) objArr[10], (LinearLayout) objArr[3], (TextView) objArr[11], (TextView) objArr[14], (TextView) objArr[16], (TextView) objArr[15], (TextView) objArr[4], (TextView) objArr[7], (TextView) objArr[9], (TextView) objArr[8]);
        this.mDirtyFlags = -1L;
