...
public class ActivityNanoSimTips3BindingImpl extends ActivityNanoSimTips3Binding {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.bt_power, 4);
        sViewsWithIds.put(R.id.bt_nano, 5);
    }

    public ActivityNanoSimTips3BindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view2) {
        this(dataBindingComponent, view2, mapBindings(dataBindingComponent, view2, 6, sIncludes, sViewsWithIds));
    }

    private ActivityNanoSimTips3BindingImpl(DataBindingComponent dataBindingComponent, View view2, Object[] objArr) {
