...
public class Oa implements Callback<AuthRandomIdRespData> {
    ...
    public final /* synthetic */ NetworkCallback f2506a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final /* synthetic */ DefaultAuthManager f2507b;

    public Oa(DefaultAuthManager defaultAuthManager, NetworkCallback networkCallback) {
        this.f2507b = defaultAuthManager;
        this.f2506a = networkCallback;
    }
    ...
    public void onSuccess(int i, AuthRandomIdRespData authRandomIdRespData) {
        ...
        NetworkCallback networkCallback = this.f2506a;
