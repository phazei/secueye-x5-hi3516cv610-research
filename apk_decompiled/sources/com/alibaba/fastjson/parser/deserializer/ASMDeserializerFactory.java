...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialzeArrayMapping(ClassWriter classWriter, Context context) {
        ...
        int i7 = 0;
        while (i7 < length) {
            boolean z3 = i7 == length + (-1) ? z2 : false;
            int i8 = z3 ? 93 : 44;
            FieldInfo fieldInfo = fieldInfoArr2[i7];
            ...
            if (cls == Byte.TYPE || cls == Short.TYPE || cls == Integer.TYPE) {
                ...
                methodWriter.visitVarInsn(i4, context.var("lexer"));
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanInt", "(C)I");
                methodWriter.visitMethodInsn(i6, "java/lang/Byte", "valueOf", "(B)Ljava/lang/Byte;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanInt", "(C)I");
                methodWriter.visitMethodInsn(i6, "java/lang/Short", "valueOf", "(S)Ljava/lang/Short;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanInt", "(C)I");
                methodWriter.visitMethodInsn(i6, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanLong", "(C)J");
                methodWriter.visitMethodInsn(i6, "java/lang/Long", "valueOf", "(J)Ljava/lang/Long;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanFloat", "(C)F");
                methodWriter.visitMethodInsn(i6, "java/lang/Float", "valueOf", "(F)Ljava/lang/Float;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                methodWriter.visitVarInsn(16, i8);
                methodWriter.visitMethodInsn(182, JSONLexerBase, "scanDouble", "(C)D");
                methodWriter.visitMethodInsn(i6, "java/lang/Double", "valueOf", "(D)Ljava/lang/Double;");
                methodWriter.visitVarInsn(i5, context.var_asm(fieldInfo));
                ...
                if (Collection.class.isAssignableFrom(cls)) {
                    ...
                    if (collectionItemClass == String.class) {
                        ...
                        _newCollection(methodWriter, cls, i7, false);
                        methodWriter.visitInsn(89);
                        methodWriter.visitVarInsn(58, context.var_asm(fieldInfo));
    ...
    private void _deserialze(ClassWriter classWriter, Context context) {
        ...
        Label label7 = new Label();
        methodWriter2.visitJumpInsn(154, label7);
        methodWriter2.visitJumpInsn(200, label3);
        ...
        methodWriter2.visitJumpInsn(200, label4);
        ...
        while (i7 < length) {
            ...
            if (cls2 == Boolean.TYPE || cls2 == Byte.TYPE || cls2 == Short.TYPE || cls2 == Integer.TYPE) {
                ...
                if (cls2 == String.class) {
                    ...
                    _setFlag(methodWriter2, context, i7);
        ...
        while (i8 < length) {
            ...
            if (cls3 == Boolean.TYPE) {
                ...
                methodWriter2.visitFieldInsn(180, JSONLexerBase, "matchStat", "I");
                methodWriter2.visitLdcInsn(5);
                methodWriter2.visitJumpInsn(160, label15);
                methodWriter2.visitInsn(1);
                methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                ...
                if (Collection.class.isAssignableFrom(cls3)) {
                    ...
                    if (collectionItemClass == String.class) {
                        ...
                        String str2 = "([CLjava/lang/Class;)" + ASMUtils.desc((Class<?>) Collection.class);
                        c2 = Typography.paragraph;
                        methodWriter2.visitMethodInsn(182, str, "scanFieldStringArray", str2);
                        c3 = ':';
                        methodWriter2.visitVarInsn(58, context.var_asm(fieldInfo3));
                    } else {
                        i3 = length;
                        methodWriter = methodWriter2;
                        _deserialze_list_obj(context, methodWriter2, label2, fieldInfo3, cls3, collectionItemClass, i8);
                        if (i8 == i3 - 1) {
                            _deserialize_endCheck(context, methodWriter, label2);
                        }
                    }
                } else {
                    i3 = length;
                    methodWriter = methodWriter2;
                    _deserialze_obj(context, methodWriter, label2, fieldInfo3, cls3, i8);
                    if (i8 == i3 - 1) {
                        _deserialize_endCheck(context, methodWriter, label2);
                    }
                }
            ...
            methodWriter2.visitFieldInsn(180, JSONLexerBase, "matchStat", "I");
            Label label20 = new Label();
            methodWriter2.visitJumpInsn(158, label20);
            ...
            methodWriter2.visitVarInsn(25, context.var("lexer"));
            methodWriter2.visitFieldInsn(180, JSONLexerBase, "matchStat", "I");
            methodWriter2.visitJumpInsn(158, label13);
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            methodWriter3.visitVarInsn(21, context.var("_asm_flag_" + i11));
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor methodVisitor, Label label, FieldInfo fieldInfo, Class<?> cls, Class<?> cls2, int i) {
        ...
        methodVisitor.visitVarInsn(25, 1);
        methodVisitor.visitVarInsn(25, context.var_asm(fieldInfo));
        methodVisitor.visitMethodInsn(i4, DefaultJSONParser, "checkListResolve", "(Ljava/util/Collection;)V");
        methodVisitor.visitVarInsn(25, context.var("lexer"));
        methodVisitor.visitMethodInsn(i4, JSONLexerBase, "token", "()I");
        methodVisitor.visitLdcInsn(16);
        ...
        methodVisitor.visitJumpInsn(i6, label7);
