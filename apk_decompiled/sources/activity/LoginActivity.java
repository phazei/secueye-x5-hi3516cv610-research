...
import com.alibaba.sdk.android.openaccount.ui.ui.NextStepActivityTemplate;
...
public class LoginActivity extends NextStepActivityTemplate {
    ...
    private String phone = "18870116190";
    private String pass = "liu123456";
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (ConfigManager.getInstance().isSupportOfflineLogin()) {
            button.setOnClickListener(new NonMultiClickListener() { // from class: activity.LoginActivity.1
            ...
            button.setOnClickListener(new NetworkCheckOnClickListener() { // from class: activity.LoginActivity.2
        ...
        this.iv_wx.setOnClickListener(new OnMultiClickListener() { // from class: activity.LoginActivity.3
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                WXApiManager wXApiManager = WXApiManager.getInstance(LoginActivity.this.getApplicationContext());
                if (!wXApiManager.isWXAppInstalled()) {
                    Toast.makeText(LoginActivity.this, "请先安装微信客户端", 0).show();
                    return;
                }
                IWXAPI wXApi = wXApiManager.getWXApi();
        ...
        this.passwordEdit.getInputBoxWithClear().getEditText().setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: activity.LoginActivity.4
        ...
        if (textView != null) {
            textView.setOnClickListener(new View.OnClickListener() { // from class: activity.LoginActivity.5
        ...
        if (textView2 != null) {
            textView2.setOnClickListener(new View.OnClickListener() { // from class: activity.LoginActivity.6
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
        ...
        if (this.oauthWidget != null) {
            if (OpenAccountSDK.getService(OauthService.class) == null) {
                ...
                this.oauthWidget.setOauthOnClickListener(new LoginCallback() { // from class: activity.LoginActivity.7
    ...
    public void login(View view2) {
        if (!OpenAccountUIConfigs.AccountPasswordLoginFlow.supportForeignMobileNumbers) {
            if (!SystemUtil.isEmail(this.loginIdEdit.getEditText().getText().toString())) {
                ToastUtils.toast(this, getString(R.string.email_invalid));
                return;
            }
        } else if (!SystemUtil.isPhone(this.loginIdEdit.getEditText().getText().toString())) {
            ToastUtils.toast(this, getString(R.string.phone_invalid));
            return;
        }
        String str = (String) null;
        login(view2, str, str, str);
    }
    ...
    protected LoginTask createLoginTask(String str, String str2, String str3) {
        ...
        String string = this.passwordEdit.getEditText().getText().toString();
        if (string != null && loginId.length() > 0) {
            if (loginId.isEmpty()) {
                loginId = this.phone;
            }
            String str4 = loginId;
            ...
            loginTask = new LoginTask(this, str4, string, str, str2, str3);
        }
        return loginTask;
    }

    /* JADX WARN: Type inference failed for: r0v5, types: [T, com.alibaba.sdk.android.openaccount.model.LoginResult] */
    ...
    public void showTipDialog(String str) {
        if (isFinishing()) {
            ...
            new AlertDialog.Builder(this).setMessage(str).setPositiveButton(ResourceUtils.getString(getApplicationContext(), "ali_sdk_openaccount_dynamic_text_iknow"), new DialogInterface.OnClickListener() { // from class: activity.LoginActivity.9
                @Override // android.content.DialogInterface.OnClickListener
                public void onClick(DialogInterface dialogInterface, int i) {
                    LoginActivity.this.loginSuccess();
                }
            }).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: activity.LoginActivity.8
    ...
    public void loginSuccess() {
        ...
        ((ExecutorService) OpenAccountSDK.getService(ExecutorService.class)).postUITask(new Runnable() { // from class: activity.LoginActivity.10
            ...
            public void run() {
                ...
                ((ExecutorService) OpenAccountSDK.getService(ExecutorService.class)).postUITask(new Runnable() { // from class: activity.LoginActivity.10.1
                    @Override // java.lang.Runnable
                    public void run() {
                        LoginActivity.this.finishWithoutCallback();
                    }
    ...
    public void forgetPassword(View view2) {
        ...
        ((OpenAccountUIService) OpenAccountSDK.getService(OpenAccountUIService.class)).showResetPassword(this, map, OpenAccountUIConfigs.UnifyLoginFlow.resetPasswordActivityClass, getResetPasswordLoginCallback());
    }

    protected LoginCallback getResetPasswordLoginCallback() {
        return new LoginCallback() { // from class: activity.LoginActivity.11
            @Override // com.alibaba.sdk.android.openaccount.callback.FailureCallback
            public void onFailure(int i, String str) {
                LoginCallback loginCallback = LoginActivity.this.getLoginCallback();
                if (loginCallback != null) {
    ...
    protected LoginCallback getRegisterLoginCallback() {
        return new LoginCallback() { // from class: activity.LoginActivity.12
            @Override // com.alibaba.sdk.android.openaccount.callback.FailureCallback
            public void onFailure(int i, String str) {
                LoginCallback loginCallback = LoginActivity.this.getLoginCallback();
                if (loginCallback != null) {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == RequestCode.NO_CAPTCHA_REQUEST_CODE && i2 == -1) {
            if (intent != null && "nocaptcha".equals(intent.getStringExtra(NativeProtocol.WEB_DIALOG_ACTION))) {
                ...
                login(view2, intent.getStringExtra("sig"), intent.getStringExtra("nocToken"), stringExtra);
            }
    ...
    private void getAccessToken(String str) {
        new OkHttpClient().newCall(new Request.Builder().url("https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + AppConfig.WX_APP_ID + "&secret=&code=" + str + "&grant_type=authorization_code").get().build()).enqueue(new Callback() { // from class: activity.LoginActivity.13
    ...
    protected class LoginTask extends TaskWithDialog<Void, Void, Result<LoginResult>> {
        ...
        public LoginTask(Activity activity2, String str, String str2, String str3, String str4, String str5) {
            super(activity2);
            Log.e("账号输入4", "loginId=" + str);
            Log.e("账号输入4", "password=" + str2);
            Log.e("账号输入4", "sig=" + str3);
            Log.e("账号输入4", "nocToken=" + str4);
            Log.e("账号输入4", "cSessionId=" + str5);
            this.loginId = str;
            this.password = str2;
            this.sig = str3;
            this.nocToken = str4;
        ...
        protected void doWhenException(Throwable th) {
            this.executorService.postUITask(new Runnable() { // from class: activity.LoginActivity.LoginTask.1
                @Override // java.lang.Runnable
                public void run() {
        ...
        public void onPostExecute(Result<LoginResult> result) {
            ...
            if (i == 4037) {
                if (OpenAccountUIConfigs.AccountPasswordLoginFlow.showAlertForPwdErrorToManyTimes) {
                    ...
                    toastUtils.alert(LoginActivity.this, "", result.message, string, new DialogInterface.OnClickListener() { // from class: activity.LoginActivity.LoginTask.2
                        @Override // android.content.DialogInterface.OnClickListener
                        public void onClick(DialogInterface dialogInterface, int i2) {
                            toastUtils.dismissAlertDialog(LoginActivity.this);
                        }
                    }, string2, new DialogInterface.OnClickListener() { // from class: activity.LoginActivity.LoginTask.3
                        @Override // android.content.DialogInterface.OnClickListener
                        public void onClick(DialogInterface dialogInterface, int i2) {
