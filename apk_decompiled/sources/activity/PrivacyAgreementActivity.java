...
public class PrivacyAgreementActivity extends CommonActivity {
    ...
    protected void initWidget(Bundle bundle) {
        ...
        this.flTitlebar.setOnViewClick(new TitleView.OnViewClick() { // from class: activity.PrivacyAgreementActivity.1
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.about_webView.loadUrl("http://paction.secueye.cn/policy.html");
    }
}
