...
public class NonEventYunServiceGiftActivity extends CommonActivity {
    ...
    public void recvYunService(String str) {
        ...
        map.put("iotId", str);
        new IoTAPIClientFactory().getClient().send(new IoTRequestBuilder().setScheme(Scheme.HTTPS).setPath("/vision/customer/cloudstorage/presented/consume").setApiVersion("2.0.0").setAuthType(AlinkConstants.KEY_IOT_AUTH).setParams(map).build(), new IoTCallback() { // from class: activity.NonEventYunServiceGiftActivity.4
            ...
            public void onResponse(IoTRequest ioTRequest, IoTResponse ioTResponse) {
                ...
                try {
                    ...
                    NonEventYunServiceGiftActivity.this.consumed = object.getIntValue("consumed");
                    NonEventYunServiceGiftActivity.this.expired = object.getIntValue("expired");
                    NonEventYunServiceGiftActivity.this.startTime = object.getString(AUserTrack.UTKEY_START_TIME);
                    NonEventYunServiceGiftActivity.this.endTime = object.getString(AUserTrack.UTKEY_END_TIME);
    ...
    /* JADX INFO: renamed from: activity.NonEventYunServiceGiftActivity$5, reason: invalid class name */
    class AnonymousClass5 implements IoTCallback {
        ...
        public void onResponse(IoTRequest ioTRequest, IoTResponse ioTResponse) {
            ...
            if (i == 0) {
                ...
                new IoTAPIClientFactory().getClient().send(new IoTRequestBuilder().setScheme(Scheme.HTTPS).setPath("/vision/customer/record/plan/set").setApiVersion("2.0.0").setAuthType(AlinkConstants.KEY_IOT_AUTH).setParams(map).build(), new IoTCallback() { // from class: activity.NonEventYunServiceGiftActivity.5.4
                    @Override // com.aliyun.iot.aep.sdk.apiclient.callback.IoTCallback
                    ...
                    public void onResponse(IoTRequest ioTRequest2, IoTResponse ioTResponse2) {
                        ...
                        try {
                            NonEventYunServiceGiftActivity.this.bindPlanToDevice(((org.json.JSONObject) data2).getString("planId"));
                        } catch (Exception e2) {
                            e2.printStackTrace();
    ...
    public void getBindYunServicePlan(String str, final String str2) {
        HashMap map = new HashMap();
        map.put("iotId", str);
        new IoTAPIClientFactory().getClient().send(new IoTRequestBuilder().setScheme(Scheme.HTTPS).setPath("/vision/customer/record/plan/getbyiotid").setApiVersion("2.0.0").setAuthType(AlinkConstants.KEY_IOT_AUTH).setParams(map).build(), new IoTCallback() { // from class: activity.NonEventYunServiceGiftActivity.6
            @Override // com.aliyun.iot.aep.sdk.apiclient.callback.IoTCallback
            public void onFailure(IoTRequest ioTRequest, Exception exc) {
                LogEx.d(true, NonEventYunServiceGiftActivity.this.TAG, exc.getLocalizedMessage());
    ...
    public void bindPlanToDevice(String str) {
        ...
        new IoTAPIClientFactory().getClient().send(new IoTRequestBuilder().setScheme(Scheme.HTTPS).setPath("/vision/customer/record/plan/bind").setApiVersion("2.0.0").setAuthType(AlinkConstants.KEY_IOT_AUTH).setParams(map).build(), new IoTCallback() { // from class: activity.NonEventYunServiceGiftActivity.7
            @Override // com.aliyun.iot.aep.sdk.apiclient.callback.IoTCallback
            public void onFailure(IoTRequest ioTRequest, Exception exc) {
                LogEx.d(true, NonEventYunServiceGiftActivity.this.TAG, exc.getLocalizedMessage());
