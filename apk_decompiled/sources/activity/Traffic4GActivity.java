...
public class Traffic4GActivity extends CommonActivity {
    ...
    protected void initWidget(Bundle bundle) {
        ...
        this.layout_customer.setOnClickListener(new OnMultiClickListener() { // from class: activity.Traffic4GActivity.2
            @Override // tools.OnMultiClickListener
            public void onMultiClick(View view2) {
                IWXAPI iwxapiCreateWXAPI = WXAPIFactory.createWXAPI(Traffic4GActivity.this, AppConfig.WX_APP_ID);
        ...
        this.webview.setWebViewClient(new WebViewClient() { // from class: activity.Traffic4GActivity.3
            ...
            public void onReceivedSslError(WebView webView, final SslErrorHandler sslErrorHandler, SslError sslError) {
                ...
                builder.setPositiveButton(Traffic4GActivity.this.getResources().getString(R.string.confirm), new DialogInterface.OnClickListener() { // from class: activity.Traffic4GActivity.3.1
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
                        sslErrorHandler.proceed();
                    }
                });
                builder.setNegativeButton(Traffic4GActivity.this.getResources().getString(R.string.cancel), new DialogInterface.OnClickListener() { // from class: activity.Traffic4GActivity.3.2
                    @Override // android.content.DialogInterface.OnClickListener
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    protected void initData() {
        ...
        if (str != null && !"".equals(str)) {
            SettingsCtrl.getInstance().getProperties(this.iotId, new MyCallback() { // from class: activity.Traffic4GActivity.4
                ...
                public void onComplete(boolean z) {
                    if (z) {
                        if (SharePreferenceManager.getInstance().getEnable(Traffic4GActivity.this.iotId) == 1) {
                            if (SharePreferenceManager.getInstance().getURL(Traffic4GActivity.this.iotId) == null || SharePreferenceManager.getInstance().getURL(Traffic4GActivity.this.iotId).equals("")) {
                                if (SharePreferenceManager.getInstance().getVendorID(Traffic4GActivity.this.iotId) != 0) {
                                    if (SharePreferenceManager.getInstance().getVendorID(Traffic4GActivity.this.iotId) != 1) {
                                        if (SharePreferenceManager.getInstance().getVendorID(Traffic4GActivity.this.iotId) == 2) {
                                            Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.4
                                            ...
                                            Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.5
                                                @Override // java.lang.Runnable
                                                public void run() {
                                    ...
                                    Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.3
                                        @Override // java.lang.Runnable
                                        public void run() {
                                            String url = SharePreferenceManager.getInstance().getURL(Traffic4GActivity.this.iotId);
                                            if (Traffic4GActivity.this.webview == null || url == null) {
                                ...
                                Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.2
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        String str2 = "http://www.secueye.cn/monitor/cardApp.html?iccid=" + Traffic4GActivity.this.iccid + "&dn=" + Traffic4GActivity.this.dn + "&pk=" + Traffic4GActivity.this.pk;
                                        if (Traffic4GActivity.this.webview == null || str2 == null) {
                            ...
                            Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    String url = SharePreferenceManager.getInstance().getURL(Traffic4GActivity.this.iotId);
                                    Log.e("链接", url);
                        ...
                        Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.6
                            @Override // java.lang.Runnable
                            public void run() {
                                String str2 = "http://www.secueye.cn/monitor/cardApp.html?iccid=" + Traffic4GActivity.this.iccid + "&dn=" + Traffic4GActivity.this.dn + "&pk=" + Traffic4GActivity.this.pk;
                                if (Traffic4GActivity.this.webview == null || str2 == null) {
                    ...
                    Traffic4GActivity.this.runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.4.7
                        @Override // java.lang.Runnable
                        public void run() {
                            String str2 = "http://www.secueye.cn/monitor/cardApp.html?iccid=" + Traffic4GActivity.this.iccid + "&dn=" + Traffic4GActivity.this.dn + "&pk=" + Traffic4GActivity.this.pk;
                            if (Traffic4GActivity.this.webview == null || str2 == null) {
            ...
            runOnUiThread(new Runnable() { // from class: activity.Traffic4GActivity.5
                @Override // java.lang.Runnable
                public void run() {
                    String str2 = "http://www.secueye.cn/monitor/cardApp.html?iccid=" + Traffic4GActivity.this.iccid + "&dn=" + Traffic4GActivity.this.dn + "&pk=" + Traffic4GActivity.this.pk;
                    if (Traffic4GActivity.this.webview == null || str2 == null) {
