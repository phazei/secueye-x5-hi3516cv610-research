...
public class RequestImpl implements Request {
    ...
    public RequestImpl(URI uri) {
        this.f2023a = uri;
        this.f2025c = uri.toString();
    }

    @Deprecated
    public RequestImpl(URL url) {
        this.f2024b = url;
        this.f2025c = url.toString();
    }
    ...
    public void setCookieEnabled(boolean z) {
        setExtProperty(RequestConstant.ENABLE_COOKIE, z ? "true" : RequestConstant.FALSE);
    }
