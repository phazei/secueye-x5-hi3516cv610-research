...
public final class ConfigModelSubscriptionDelete extends ConfigMessageState {
    ...
    public ConfigModelSubscriptionDelete(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, int i, byte[] bArr, byte[] bArr2, int i2) {
    ...
    private void createAccessMessage() {
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32796, bArrArray);
