...
public class GenericLevelGet extends GenericMessageState {
    ...
    public GenericLevelGet(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, MeshModel meshModel, boolean z, byte[] bArr, int i) {
    ...
    private void createAccessMessage() {
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.dstAddress, byteArray, 1, SecureUtils.calculateK4(byteArray), this.mAszmic, 33285, null);
    ...
    public void executeSend() {
        q qVar;
        a.a(TAG, "Sending Generic Level get");
        super.executeSend();
