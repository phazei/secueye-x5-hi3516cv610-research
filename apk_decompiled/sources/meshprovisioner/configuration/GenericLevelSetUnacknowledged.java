...
public class GenericLevelSetUnacknowledged extends GenericMessageState {
    ...
    public GenericLevelSetUnacknowledged(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, MeshModel meshModel, boolean z, byte[] bArr, int i, Integer num, Integer num2, Integer num3, int i2) {
    ...
    private void createAccessMessage() {
        ...
        if (this.mTransitionSteps == null || this.mTransitionResolution == null || this.mDelay == null) {
            ...
            a.a(TAG, "Transition steps: " + this.mTransitionSteps);
            a.a(TAG, "Transition step resolution: " + this.mTransitionResolution);
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.dstAddress, byteArray, 1, SecureUtils.calculateK4(byteArray), this.mAszmic, 33287, bArrArray);
