...
public final class ConfigModelAppBind extends ConfigMessageState {
    ...
    public ConfigModelAppBind(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, int i, byte[] bArr, int i2, int i3) {
    ...
    private void createAccessMessage() {
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32829, bArrArray);
    ...
    public final void executeSend() {
        q qVar;
        a.a(TAG, "Sending config app bind");
        super.executeSend();
