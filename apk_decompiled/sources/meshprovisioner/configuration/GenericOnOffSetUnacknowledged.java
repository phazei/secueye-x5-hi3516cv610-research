...
public class GenericOnOffSetUnacknowledged extends GenericMessageState {
    ...
    public GenericOnOffSetUnacknowledged(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, MeshModel meshModel, boolean z, byte[] bArr, int i, Integer num, Integer num2, Integer num3, boolean z2) {
    ...
    private void createAccessMessage() {
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.dstAddress, byteArray, 1, SecureUtils.calculateK4(byteArray), this.mAszmic, 33283, bArrArray);
