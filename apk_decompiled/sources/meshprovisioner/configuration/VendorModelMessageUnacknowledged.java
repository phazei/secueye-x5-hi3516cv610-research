...
public class VendorModelMessageUnacknowledged extends VendorModelMessageState {
    ...
    public VendorModelMessageUnacknowledged(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, MeshModel meshModel, boolean z, byte[] bArr, int i, int i2, byte[] bArr2) {
    ...
    public void executeSend() {
        a.a(TAG, "Sending unacknowledged vendor model message");
        super.executeSend();
    }
