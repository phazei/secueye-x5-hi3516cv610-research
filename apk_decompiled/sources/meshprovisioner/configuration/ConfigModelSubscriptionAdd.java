...
public final class ConfigModelSubscriptionAdd extends ConfigMessageState {
    ...
    public ConfigModelSubscriptionAdd(Context context, ProvisionedMeshNode provisionedMeshNode, InterfaceC0369c interfaceC0369c, int i, byte[] bArr, byte[] bArr2, int i2) {
    ...
    private void createAccessMessage() {
        ...
        this.message = this.mMeshTransport.createMeshMessage(this.mProvisionedMeshNode, this.mSrc, this.mProvisionedMeshNode.getDeviceKey(), 0, 0, this.mAszmic, 32795, bArrArray);
    ...
    public final void executeSend() {
        q qVar;
        a.a(TAG, "Sending config model subscription add");
        super.executeSend();
