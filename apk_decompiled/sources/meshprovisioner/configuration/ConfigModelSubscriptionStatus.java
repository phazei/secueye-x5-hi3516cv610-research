...
public class ConfigModelSubscriptionStatus extends ConfigMessageState {
    ...
    /* JADX INFO: renamed from: meshprovisioner.configuration.ConfigModelSubscriptionStatus$1, reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        public static final /* synthetic */ int[] $SwitchMap$meshprovisioner$configuration$ConfigModelSubscriptionStatus$SubscriptionStatus = new int[SubscriptionStatus.values().length];

        static {
            try {
                $SwitchMap$meshprovisioner$configuration$ConfigModelSubscriptionStatus$SubscriptionStatus[SubscriptionStatus.SUCCESS.ordinal()] = 1;
    ...
    public enum SubscriptionStatus {
        ...
        public static SubscriptionStatus fromStatusCode(int i) {
            for (SubscriptionStatus subscriptionStatus : values()) {
                if (subscriptionStatus.getStatusCode() == i) {
    ...
    public ConfigModelSubscriptionStatus(Context context, ProvisionedMeshNode provisionedMeshNode, int i, InterfaceC0369c interfaceC0369c) {
    ...
    private void parseStatus(int i) {
        if (AnonymousClass1.$SwitchMap$meshprovisioner$configuration$ConfigModelSubscriptionStatus$SubscriptionStatus[SubscriptionStatus.fromStatusCode(i).ordinal()] != 1) {
            return;
        }
    ...
    public static String parseStatusMessage(Context context, int i) {
        switch (AnonymousClass1.$SwitchMap$meshprovisioner$configuration$ConfigModelSubscriptionStatus$SubscriptionStatus[SubscriptionStatus.fromStatusCode(i).ordinal()]) {
            case 1:
    ...
    public final boolean parseMeshPdu(byte[] bArr) {
        ...
        if (pdu == null) {
            ...
            if (MeshParserUtils.getOpCode(bArrU, ((bArrU[0] >> 7) & 1) + 1) == -32737) {
                a.a(TAG, "Received model subscription status");
                this.status = bArrU[2];
                ...
                a.a(TAG, "Subscription Address: " + MeshParserUtils.bytesToHex(this.mSubscriptionAddress, false));
